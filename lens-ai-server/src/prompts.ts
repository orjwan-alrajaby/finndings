...
- budget — only when they give a monthly figure. kind "hardMax" when the figure is a line they want to stay under, however politely put: "I can't spend more than €500", "no more than 500", "I'd really like to stay under €450", "under 400 please". kind "target" only when the figure itself is approximate or explicitly flexible: "around €500", "roughly 450", "ideally under 500 but I could stretch". Convert yearly amounts to monthly.
